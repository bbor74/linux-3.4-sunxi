...
*Parameter    :
*Return       :
*Note         :The first node does not store valid data, so it is easy to insert quickly
*****************************************************************************/
...
*Parameter    :
*Return       :
*Note         :Maximum number of erasures under the parameter erase_time
*****************************************************************************/
...
*Parameter    :
*Return       :
*Note         :The minimum number of erasures under the parameters erase_time and max_data
*****************************************************************************/

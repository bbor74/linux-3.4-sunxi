...
{
    //If it is a new block, it needs to be initialized first
...
*Parameter    :
*Return       :
*Note         :This function only writes data to current_block, ensure that there is enough space and the correct block before calling
*****************************************************************************/

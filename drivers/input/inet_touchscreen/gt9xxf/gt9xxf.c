...
extern void tp_light_ctrl(int i);//defined inet sw_device.c
...
const char *goodix_ts_name="gtxxf_ts";
...
#define GT9XXF_IC_INFO  "\n============================================================== \
												  \nIC	 :GT9XXF  \
												  \nAUTHOR :mbgalex@163.com \
												  \nVERSION:2013-10-30_09:34\n"

											  
static int D978_index =0;
static int ctp_cob_gt9xx  = 0;
static int ctp_cob_gt9xxf = 0;
...
void gtp_set_int_value(int status)
{
	    ...
	    pin_config_get(SUNXI_PINCTRL,irq_pin_name,&config);
	    if(status !=SUNXI_PINCFG_UNPACK_VALUE(config) )
	          config = SUNXI_PINCFG_PACK(SUNXI_PINCFG_TYPE_PUD,status);
      pin_config_set(SUNXI_PINCTRL, irq_pin_name, config);
      */
...
static void gtp_touch_down(struct goodix_ts_data* ts,s32 id,s32 x,s32 y,s32 w)
{
	...
	switch(ctp_cob_gt9xxf)
	{
		case 798:
			if(x>450 && x<480 && y>1050 && y<1076)
			{
	...
	GTP_INFO("g_sensorid=%d \n",g_sensorid);
if(ctp_cob_gt9xxf==978 && g_sensorid !=3){

	x=screen_max_x-x;
	GTP_INFO("x=%d---invert to screen_max_x-x =%d \n",x,x);
}
...
static void goodix_ts_work_func(struct work_struct *work)
{
	...
	u8 doze_buf[3] = {0x81, 0x4B};
        ...
        tp_light_ctrl(1);
  //	printk("I2C address ====================================== 0x%2x\n",i2c_connect_client->addr);
	...
	{
		case 798:
			if((touch_num==0) && (key_state_flag==1) )
			{
...
static s32 gtp_init_panel(struct goodix_ts_data *ts)
{
	...
	if(ctp_cob_gt9xxf == 978)
	{
		printk("download D978\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_D978;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_D978;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_D978;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_D978;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_D978;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_D978;
	...
	else if(ctp_cob_gt9xxf == 7910)
	{
		printk("download CTP_CFG_GROUP1_DZ_79D2\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_DZ_79D2;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_DZ_79D2;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_DZ_79D2;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_DZ_79D2;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_DZ_79D2;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_DZ_79D2;
	...
	else if(ctp_cob_gt9xxf == 7911)
	{
		printk("download CTP_CFG_GROUP1_DZ_79D4\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_DZ_79D4;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_DZ_79D4;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_DZ_79D4;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_DZ_79D4;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_DZ_79D4;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_DZ_79D4;
	...
	else if(ctp_cob_gt9xxf == 7912)
	{
		printk("download CTP_CFG_GROUP1_PG\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_PG;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_PG;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_PG;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_PG;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_PG;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_PG;
	...
	else if(ctp_cob_gt9xxf == 7913)
	{
		printk("download CTP_CFG_GROUP1_GG\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_GG;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_GG;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_GG;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_GG;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_GG;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_GG;
	...
	else if(ctp_cob_gt9xxf == 7914)
	{
		printk("download CTP_CFG_GROUP1_OGS_SG5908A\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_OGS_SG5908A;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_OGS_SG5908A;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_OGS_SG5908A;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_OGS_SG5908A;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_OGS_SG5908A;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_OGS_SG5908A;
	...
	else if(ctp_cob_gt9xxf == 7915)
	{
		printk("download CTP_CFG_GROUP1_HS_G1F\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_HS_G1F;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_HS_G1F;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_HS_G1F;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_HS_G1F;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_HS_G1F;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_HS_G1F;
	...
	else if(ctp_cob_gt9xxf == 7916)
	{
		printk("download CTP_CFG_GROUP1_JND\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_JND;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_JND;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_JND;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_JND;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_JND;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_JND;
	...
	else if(ctp_cob_gt9xxf == 750)
	{
		printk("D750 init panel test!now come in 750\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_D750;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_D750;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_D750;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_D750;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_D750;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_D750;
	...
	{
		printk("Download D798\n");
		u8 cfg_info_group1[] = CTP_CFG_GROUP1_D798;
		u8 cfg_info_group2[] = CTP_CFG_GROUP2_D798;
		u8 cfg_info_group3[] = CTP_CFG_GROUP3_D798;
		u8 cfg_info_group4[] = CTP_CFG_GROUP4_D798;
		u8 cfg_info_group5[] = CTP_CFG_GROUP5_D798;
		u8 cfg_info_group6[] = CTP_CFG_GROUP6_D798;
...
static s32 gtp_esd_recovery(struct i2c_client *client)
{
	...
	*/
	...
	/*
	gtp_i2c_write(client, esd_buf, 3);
		esd_buf[1] = 0x27;
	gtp_i2c_write(client, esd_buf, 3);
		esd_buf[1] = 0x28;
	gtp_i2c_write(client, esd_buf, 3);
...
{   
	script_item_u   val;
	/*
	if(SCIRPT_ITEM_VALUE_TYPE_INT != script_get_item("ctp_para", "ctp_cob_gt9xx", &val))
	{
		ctp_cob_gt9xx=0;
	}
	else
	{
		ctp_cob_gt9xx = val.val;
	}
	
	printk("ctp_cob_gt9xx=%d\n",ctp_cob_gt9xxf);
	...
	*/
	...
	if(SCIRPT_ITEM_VALUE_TYPE_INT != script_get_item("ctp_para", "ctp_cob_gt9xxf", &val))
	{
		ctp_cob_gt9xxf=0;
	}
	else
	{
		ctp_cob_gt9xxf = val.val;
	}
	//ctp_cob_gt9xxf = 7915;
	printk("ctp_cob_gt9xxf=%d\n",ctp_cob_gt9xxf);

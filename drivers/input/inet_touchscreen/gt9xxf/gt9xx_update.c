...
#include <linux/mount.h>
    ...
    #include "gt912_firmware.h"
#endif

#ifdef GT963_FIRMWARE_CONFIG
    #include "gt963_firmware.h"
#endif	
#endif
...
extern void gtp_recovery_reset(struct i2c_client *client);
...
s32 gup_fw_download_proc(void *dir, u8 dwn_mode)
{
	...
	{
		case 750:
			gtp_default_FW_fl = gtp_default_FW_fl_GT912;
			break;
		default:
			gtp_default_FW_fl = gtp_default_FW_fl_GT963;
			break;
	}
	*/
    s32 ret = 0;

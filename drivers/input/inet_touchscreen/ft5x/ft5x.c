...
#define FT5X02_FT5X06_IC_INFO  "\n============================================================== \
						 \nIC     :Focal ft5x02 ft5x06  \
                         \nAUTHOR :mbgalex@163.com \
                         \nVERSION:2013-11-01_01:06\n"
...
static void ft5x_report_multitouch(void)
{
...
#endif
	//printk("chip_type=0x%x\n",chip_id);
	switch(event->touch_point) {
	case 5:
		if(chip_id = 0x2)
		{
			if((event->x5>4000)&&(event->y5>4000))  		
						return;
		}
		input_report_abs(data->input_dev, ABS_MT_TRACKING_ID, event->touch_ID5);	
		input_report_abs(data->input_dev, ABS_MT_TOUCH_MAJOR, event->pressure);
		input_report_abs(data->input_dev, ABS_MT_POSITION_X, (event->x5)+1);
		input_report_abs(data->input_dev, ABS_MT_POSITION_Y, (event->y5)+1);
	...
	case 4:
		...
		input_report_abs(data->input_dev, ABS_MT_TOUCH_MAJOR, event->pressure);
		input_report_abs(data->input_dev, ABS_MT_POSITION_X, (event->x4)+1);
		input_report_abs(data->input_dev, ABS_MT_POSITION_Y, (event->y4)+1);
		input_report_abs(data->input_dev, ABS_MT_WIDTH_MAJOR, 1);
		input_mt_sync(data->input_dev);
	...
	case 3:
		...
		input_report_abs(data->input_dev, ABS_MT_TOUCH_MAJOR, event->pressure);
		input_report_abs(data->input_dev, ABS_MT_POSITION_X, (event->x3)+1);
		input_report_abs(data->input_dev, ABS_MT_POSITION_Y, (event->y3)+1);
		input_report_abs(data->input_dev, ABS_MT_WIDTH_MAJOR, 1);
		input_mt_sync(data->input_dev);
	...
	case 2:
		...
		input_report_abs(data->input_dev, ABS_MT_TOUCH_MAJOR, event->pressure);
		input_report_abs(data->input_dev, ABS_MT_POSITION_X, (event->x2)+1);
		input_report_abs(data->input_dev, ABS_MT_POSITION_Y, (event->y2)+1);
		input_report_abs(data->input_dev, ABS_MT_WIDTH_MAJOR, 1);
		input_mt_sync(data->input_dev);
	...
	case 1:
		...
		input_report_abs(data->input_dev, ABS_MT_TOUCH_MAJOR, event->pressure);
		input_report_abs(data->input_dev, ABS_MT_POSITION_X, (event->x1)+1);
		input_report_abs(data->input_dev, ABS_MT_POSITION_Y, (event->y1)+1);
		input_report_abs(data->input_dev, ABS_MT_WIDTH_MAJOR, 1);
		input_mt_sync(data->input_dev);
